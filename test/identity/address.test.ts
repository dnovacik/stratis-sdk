import { fromMnemonic, fromPrivateKey, fromPublicKey, fromWIF } from './../../src/identity/address'
...
fdescribe('Identity.Address tests', () => {
  ...
  it('should get correct address from passphrase', () => {
    const result = fromMnemonic(mnemonic, passphrase)
